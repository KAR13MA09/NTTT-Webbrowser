...
black_webbrowser_version = "NTTT-Webbrowser v1.0"
help_arg = """
NTTT-Webbrowser v1.0 Argument:
...
class Window(QMainWindow):
    ...
    def Main(self):
        ...
        self.setWindowIcon(QIcon("./Icon/NTTT-webbrowser-icon.jpg"))
...
""")
    ...
    def setting(self):
        ...
        dlg.instagram_btn.clicked.connect(lambda: self.browser.setUrl(QUrl("https://instagram.com/")))
        dlg.twitter_btn.clicked.connect(lambda: self.browser.setUrl(QUrl("https://twitter.com/i")))
        dlg.facebook_btn.clicked.connect(lambda: self.browser.setUrl(QUrl("https://instagram.com/")))
        dlg.github_btn.clicked.connect(lambda: self.browser.setUrl(QUrl("https://github.com/KAR13MA09")))
        dlg.telegram_btn.clicked.connect(lambda: self.browser.setUrl(QUrl("https://instagram.com/")))
        dlg.send_emailbtn.clicked.connect(lambda: self.browser.setUrl(QUrl("email:Nguyentrinhtuantu1110@gmail.com")))
    ...
    def history(self):
        ...
        h_win.setWindowTitle("NTTT-Webbrowser/History")
    ...
    # def downloads(self):
    #     dlg = QDialog(self)
    #     dlg.setWindowTitle("NTTT-Webbrowser/Downloads")
    ...
    def bookmark(self):
        ...
        book_win.setWindowTitle("NTTT-Webbrowser/Bookmarks")
    ...
    def update_title(self):
        ...
        self.setWindowTitle(f"NTTT-Webbrowser - {title}")
    ...
    def help_(self):
        help_text = """NTTT-Webbrowser v2.0
...
"""
        dlg = QDialog(self)
        dlg.setWindowTitle("NTTT-Webbrowser/Help")
        ...
        rev = dlg.exec_()
    def about(self):
        about_text = """Developer: KAR13MA09
Version v2.0
Source: https://github.com/KAR13MA09
"""
        dlg = QDialog(self)
        dlg.setWindowTitle("NTTT-Webbrowser/َAbout")
        dlg.setGeometry(800,200,500,500)
        dlg.setFixedSize(500,500)
        text = QTextEdit(dlg)
        text.resize(500,500)
    ...
    def license_(self):
        ...
        dlg = QDialog(self)
        dlg.setWindowTitle("NTTT-Webbrowser/َLicense")
    ...
    def send_feedback(self):
        self.browser.setUrl(QUrl("https://github.com/KAR13MA09"))
    def set_status(self):
        x = 100
        for i in range(x):
            status = QStatusBar(self)
            status.setStyleSheet("color: #000;")
            status.showMessage("NTTT-Webbrowser v1.0")
            self.setStatusBar(status)
            x += 100 
    def source(self):
        webbrowser.open_new_tab("https://github.com/KAR13MA09")
...
def main():
    ...
    app.setApplicationName("NTTT-Webbrowser")
